      ...
      <main className="container max-w-6xl px-4 py-6 space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          <div className="rounded-lg border bg-card p-3">
            ...
            <p className="text-lg font-bold font-mono text-foreground">{bus.mileage.toLocaleString()}</p>
          </div>
          <div className="rounded-lg border bg-card p-3">
            <div className="flex items-center gap-2 text-muted-foreground mb-1">
            ...
            <p className="text-lg font-bold font-mono text-foreground">{getDaysAgo(bus.lastServiceDate)}d ago</p>
          </div>
          <div className="rounded-lg border bg-card p-3">
            <div className="flex items-center gap-2 text-muted-foreground mb-1">
              <Calendar className="h-3.5 w-3.5" />
          ...
          <div className="rounded-lg border bg-card p-3">
            ...
            <p className="text-sm font-bold text-foreground">{bus.year} {bus.model}</p>
          </div>
        </div>
